...
import ManageItemComponent from "../../../component/pages/dashboard/manage-items/manage-item-component";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbList,
  ...
  return (
    <main>
      <Helmet>
        ...
        <link rel="canonical" href={`${BASE_URL}/dashboard/manageitem`} />
      </Helmet>
      <SidebarProvider>
        <AppSidebar />
        <SidebarInset>
          <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Manage Item</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </header>
